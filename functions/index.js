 ...
 *
 * Extracted to ./src/rateLimit.js so the fail-closed contract is
 * unit-testable (functions/src/__tests__/rateLimit.test.js). Behaviour is
 * unchanged by the move — see that file's header.
 * ====================================================================*/
