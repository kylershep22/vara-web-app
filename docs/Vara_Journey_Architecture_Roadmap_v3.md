...
### 2026-09-14 - slice 7l built: five approved protocols stop being unreachable, and the function that made it possible had never been tested (branch `journey/slice-7l-destination-weighting`, `5d6d6ec` the weights, `a0519dc` the serve table, `87eee1e` the ordering tests and the doc-comment correction, this entry the docs; **UNMERGED AND UNWALKED**, plan at `docs/walks/7l/WALK.md`)
