...
> **AMENDED 2026-09-17 (NEW-MESSAGE-SHEET's merge close). THE FOUR BEFORE-BETA ROWS RUN IN
> TABLE ORDER LIKE EVERYTHING ELSE, AND NO SEPARATE PRIORITY ORDERING EXISTS FOR THEM.**
>
> The four rows carrying **[READY]** on this board are `DURATION-PRESETS`,
> `REPRESENTATIVE-PROTOCOL`, `TODAY-CARD-AFFORDANCES` and `KEYBOARD-DISMISS-UNIFORM`. All four
> are **NOT AN R-SERIES ROW / OWN SLICE, BEFORE BETA**; none gates another, and none is gated by
> the R-series.
>
...
> 2026-09-11 amendment below governs these four exactly as it governs the 7-series: table order
...
> true of these four as of every numbered row above them.
>
...
> **RIDER, 2026-09-18 (slice 8's build). THE BEFORE-BETA COUNT IS NOW SIX, AND TWO FURTHER
> [READY] ROWS ARE NOT BEFORE-BETA AT ALL. THE BLOCK ABOVE AND THE RIDER ABOVE ARE BOTH LEFT
> UNEDITED, IN THE §3.4 STYLE.** This is the LAST correction of that enumeration that should be
> needed, because it stops quoting a number for a set that grows.
>
> **BEFORE-BETA, SIX:** `DURATION-PRESETS`, `REPRESENTATIVE-PROTOCOL`, `TODAY-CARD-AFFORDANCES`,
> `KEYBOARD-DISMISS-UNIFORM`, `JOURNEY-REVISION-TOKEN` and, added by slice 8,
> `TOAST-RELIABILITY`. Everything the 2026-09-17 block says applies to the sixth unchanged: it
> gates nothing, nothing gates it, and it runs where the table puts it.
>
> **NOT BEFORE-BETA, TWO, AND THE DISTINCTION IS THE POINT OF THIS RIDER.** Slice 8 also added
> `GRATITUDE-COPY-SWEEP` (**[READY, JEN-GATED, NEAR-TERM]**) and `LEGACY-MOMENT-COLLECTIONS`
> (**[READY, LOWER PRIORITY]**). Both carry **[READY]** and NEITHER is before-beta. **A reader
> counting [READY] rows and reading the answer as the before-beta queue now gets eight and is
> wrong by two** - which is exactly the reading the 2026-09-17 block warned against, arriving
> from the other direction. **[READY] means the row can be started. "Before beta" is a separate
> classification and is stated on the row or it does not apply.**
>
