...
### 2026-09-14 - R2 built and walked: the bar floats, and sixteen routes discover they were never clearing it (branch `design/slice-r2-floating-nav`, commit count set at the merge, **UNMERGED**, **SECTION A WALKED IN FULL on an iPhone 14 Plus, fifteen steps passed; Sections B and C NOT RUN**, plan and results at `docs/walks/r2/WALK.md`)
