...
### 2026-09-16 - NEW-MESSAGE-SHEET built: the sheet could not shrink, so it left the screen instead (branch `fix/new-message-sheet`, `7f415f7` the fix, `6deb614` the tests, this entry the docs; **BEFORE-STATE CAPTURE RUN AND PASSED 2026-09-16 on `main` — steps 0, 0b and 0c, iPhone 14 Plus, and the mechanism is CONFIRMED ON HARDWARE; the branch half of the walk is OUTSTANDING; UNMERGED**, script and results at `docs/walks/new-message-sheet/WALK.md`)
