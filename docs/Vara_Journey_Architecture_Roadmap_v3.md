...
### 2026-09-13 - R1b-i built: Muted Sage Gray stops failing AA, and the row's premise was false (branch `design/slice-r1b-i-helper-gray`, SIX commits, unmerged, WALKED 2026-09-13)
...
AND ARE SIX NOW**, because the walk-result and attestation commits landed after each was
