...
### 2026-09-14 - R2 built: the bar floats, and sixteen routes discover they were never clearing it (branch `design/slice-r2-floating-nav`, SEVEN commits, **UNMERGED, UNWALKED**, walk plan at `docs/walks/r2/WALK.md`)
...
| docs | this commit | standards, roadmap, backlogs, walk script, memory |
...
**THE `#6F7F77` FALLBACK TOKEN IS NOT BUILT AND IS PROPOSED CLOSED AS SUPERSEDED, PENDING
WALK A10b.** A filled/outline glyph switch is a shape difference; it survives colour
...
**STILL OWED, AND THE SLICE IS NOT DONE WITHOUT IT:** the walk. Section A is the gate,
Section B is R1a's fourteen and is required before R3, Section C is opportunistic.
**8 to 10 hours across at least three sittings**, and the script says so on its first page
