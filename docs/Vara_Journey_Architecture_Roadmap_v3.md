...
### 2026-09-13 - R1b-i built: Muted Sage Gray stops failing AA, and the row's premise was false (branch `design/slice-r1b-i-helper-gray`, SEVEN commits, unmerged, WALKED 2026-09-13)
...
`0b1e5be` the count correction below.

**THE COUNTS IN THIS HEADING AND IN THE ROW MARKER WERE FOUR AND FIVE WHEN THEY WERE WRITTEN
AND ARE SEVEN NOW**, because the walk-result and attestation commits landed after each was
typed. Corrected rather than left, on the R1a precedent: the heading is what a later reader
counts against the log. The heading also read WALK OUTSTANDING and now reads WALKED.
