...
### 2026-09-16 - NEW-MESSAGE-SHEET built: the sheet could not shrink, so it left the screen instead (branch `fix/new-message-sheet`, `7f415f7` the fix, `6deb614` the tests, this entry the docs; **UNWALKED, UNMERGED**, script at `docs/walks/new-message-sheet/WALK.md`)
