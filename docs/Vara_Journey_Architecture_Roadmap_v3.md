...
**THE WALK HAS NOT HAPPENED.** Nothing here is attested on device. Three merges in
the other project stream already went in without their walks (guide pill,
onboarding circumplex rehost, dashboard completion-ack); this one should not join
them.
