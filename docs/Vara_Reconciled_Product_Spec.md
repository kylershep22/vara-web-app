...
**Version 1.6 | July 2026 | Single source of truth**
*(v1.6: slice 4 shipped; open item #10 (floorMet derivation for continuity) tracked, resolves at weekly-close. v1.5: slices 1/2/3a shipped, 3b deferred post-launch. v1.4: org-ID invariant. v1.3: diagnostic reconciliation.)*
