...
const NutritionSection = ({ userId }) => {
  return (
    <div className="space-y-6">
      {/* Coming Soon Banner */}
      <div className="bg-gradient-to-r from-teal-light to-teal-light border border-evergreen-teal/30 rounded-xl p-8 text-center">
        <Apple className="mx-auto mb-4 text-evergreen-teal" size={48} />
        <h2 className="text-2xl font-bold text-soft-charcoal mb-2">Nutrition for Brain Health</h2>
        <p className="text-soft-charcoal mb-4 max-w-2xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        <div className="bg-white border border-divider rounded-xl p-6">
          <Brain className="text-evergreen-teal mb-3" size={32} />
          <h3 className="font-semibold text-soft-charcoal mb-2">Brain-Healthy Foods</h3>
          <ul className="text-sm text-muted-sage-gray space-y-1">
        ...
        <div className="bg-white border border-divider rounded-xl p-6">
          <Droplet className="text-evergreen-teal mb-3" size={32} />
          <h3 className="font-semibold text-soft-charcoal mb-2">Hydration</h3>
        ...
        <div className="bg-white border border-divider rounded-xl p-6">
          <Coffee className="text-evergreen-teal mb-3" size={32} />
          <h3 className="font-semibold text-soft-charcoal mb-2">Caffeine Strategy</h3>
          <p className="text-sm text-muted-sage-gray mb-3">
        ...
        <div className="bg-white border border-divider rounded-xl p-6">
          <Apple className="text-evergreen-teal mb-3" size={32} />
          <h3 className="font-semibold text-soft-charcoal mb-2">Blood Sugar</h3>
          <p className="text-sm text-muted-sage-gray mb-3">
      ...
      <div className="bg-white rounded-xl border border-divider p-6">
        <h3 className="text-xl font-semibold text-soft-charcoal mb-4">Quick Nutrition Wins for Brain Health</h3>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="border-l-4 border-evergreen-teal/30 pl-4">
            <h4 className="font-semibold text-soft-charcoal mb-2">Start Your Day Right</h4>
          ...
          <div className="border-l-4 border-evergreen-teal pl-4">
            <h4 className="font-semibold text-soft-charcoal mb-2">Omega-3s are Essential</h4>
            <p className="text-sm text-muted-sage-gray">
          ...
          <div className="border-l-4 border-evergreen-teal pl-4">
            <h4 className="font-semibold text-soft-charcoal mb-2">Gut-Brain Connection</h4>
            <p className="text-sm text-muted-sage-gray">
          ...
          <div className="border-l-4 border-evergreen-teal pl-4">
            <h4 className="font-semibold text-soft-charcoal mb-2">Timing Matters</h4>
            <p className="text-sm text-muted-sage-gray">
      ...
      <div className="bg-white border border-divider rounded-xl p-6 text-center">
        <h3 className="font-semibold text-soft-charcoal mb-2">Coming Soon</h3>
