 ...
 *
 * AN OPEN DOOR, NOT A GATE. Nothing here scolds and nothing here is blocked:
 * the user has not failed to do something by not having answered yet. It is one
 * invitation with one tap behind it, in the same slot the day's action will
 * occupy, so the surface does not jump when they answer.
 *
