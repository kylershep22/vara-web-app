...
export const FEATURE_PREVIEW_CONTENT: Record<DiscoverableFeatureId, FeaturePreviewContent> = {
  ...
  community: {
    ...
    description: 'Share experiences and learn alongside others who are building brain-healthy habits. Community in Vara is supportive and low-pressure — no performance metrics, no comparison.',
  ...
  messaging: {
    ...
    description: 'Send private messages to community members you connect with — build meaningful relationships at your own pace.',
